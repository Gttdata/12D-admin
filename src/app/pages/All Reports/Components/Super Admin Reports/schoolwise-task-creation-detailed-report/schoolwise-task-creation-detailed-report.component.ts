...
@Component({
  selector: 'app-schoolwise-task-creation-detailed-report',
  templateUrl: './schoolwise-task-creation-detailed-report.component.html',
  styleUrls: ['./schoolwise-task-creation-detailed-report.component.css']
})
export class SchoolwiseTaskCreationDetailedReportComponent implements OnInit {
  formTitle = 'School wise Task Creation Detailed Report ';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  sort(params: NzTableQueryParams): void {
    ...
    const sortField = (currentSort && currentSort.key) || 'SCHOOL_ID';
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['No Of Task Assigned'] = this.exportdataList[i]['TASK_COUNT'];
      ...
      if (i == this.exportdataList.length - 1) {
        this.exportservice.exportExcel(
          arry1,
          'School Wise Task Creation Detailed Report' +
