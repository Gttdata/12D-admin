...
@Component({
  selector: 'app-animationsummary',
  templateUrl: './animationsummary.component.html',
  styleUrls: ['./animationsummary.component.css']
})
export class AnimationsummaryComponent implements OnInit {
  formTitle = 'Animation Summary Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  sort(params: NzTableQueryParams): void {
    ...
    const sortField = (currentSort && currentSort.key) || 'ANIMATION_ID';
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['No Of Purchase'] = this.exportdataList[i]['NUMBER_OF_PURCHASE'];
