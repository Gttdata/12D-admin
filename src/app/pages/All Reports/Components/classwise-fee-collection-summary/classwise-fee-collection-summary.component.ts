...
@Component({
  selector: 'app-classwise-fee-collection-summary',
  templateUrl: './classwise-fee-collection-summary.component.html',
  styleUrls: ['./classwise-fee-collection-summary.component.css'],
})
export class ClasswiseFeeCollectionSummaryComponent implements OnInit {
  formTitle = ' Class Wise Fee Collection Summary Report ';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    if (this.exportdataList.length > 0) {
      for (var i = 0; i < this.exportdataList.length; i++) {
        obj1['Total Classes'] = this.exportdataList[i]['TOTAL_CLASSES'];
        // obj1['Year'] = this.exportdataList[i]['YEAR'];
        obj1['Total Collected'] = this.exportdataList[i]['TOTAL_COLLECTED'];
        obj1['Total Pending'] = this.exportdataList[i]['TOTAL_PENDING'];

        arry1.push(Object.assign({}, obj1));
        if (i == this.exportdataList.length - 1) {
          this.exportservice.exportExcel(
            arry1,
            'Classwise Fee Summary Report ' +
