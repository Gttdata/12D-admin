...
@Component({
  selector: 'app-couponcodeusagesummary',
  templateUrl: './couponcodeusagesummary.component.html',
  styleUrls: ['./couponcodeusagesummary.component.css']
})
export class CouponcodeusagesummaryComponent implements OnInit {

  formTitle = 'Coupon Code Usage Summary Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  sort(params: NzTableQueryParams): void {
    ...
    const sortField = (currentSort && currentSort.key) || 'COUPON_ID';
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Coupon Amount'] = this.exportdataList[i]['COUPON AMOUNT'];
      obj1['Buy User Count'] = this.exportdataList[i]['BUY_USER_COUNT'];
      ...
      if (i == this.exportdataList.length - 1) {
        this.exportservice.exportExcel(
          arry1,
          'Coupon Code Usage Summary Report ' +
