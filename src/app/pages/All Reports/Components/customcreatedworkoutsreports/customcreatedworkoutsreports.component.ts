...
@Component({
  selector: 'app-customcreatedworkoutsreports',
  templateUrl: './customcreatedworkoutsreports.component.html',
  styleUrls: ['./customcreatedworkoutsreports.component.css']
})
export class CustomcreatedworkoutsreportsComponent implements OnInit {

  formTitle = 'Custom Created Workout Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
