...
@Component({
  selector: 'app-perioddetailedreport',
  templateUrl: './perioddetailedreport.component.html',
  styleUrls: ['./perioddetailedreport.component.css'],
})
export class PerioddetailedreportComponent implements OnInit {
  formTitle = 'Period Detailed Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Period Start Date'] = this.exportdataList[i]['PERIOD_START_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['PERIOD_START_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Period End Date'] = this.exportdataList[i]['PERIOD_END_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['PERIOD_END_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Fertile Start Date'] = this.exportdataList[i]['FERTILE_START_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['FERTILE_START_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Fertile End Date'] = this.exportdataList[i]['FERTILE_END_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['FERTILE_END_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Ovulation Start Date'] = this.exportdataList[i][
        'OVULATION_START_DATE'
      ]
        ? this.datePipe.transform(
            this.exportdataList[i]['OVULATION_START_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Ovulation End Date'] = this.exportdataList[i]['OVULATION_END_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['OVULATION_END_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Safe Start Date'] = this.exportdataList[i]['SAFE_START_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['SAFE_START_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
      obj1['Safe End Date'] = this.exportdataList[i]['SAFE_END_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['SAFE_END_DATE'],
            'dd/MMM/yyyy'
          )
        : '';
