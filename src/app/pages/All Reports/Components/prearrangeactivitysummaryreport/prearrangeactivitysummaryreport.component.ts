...
@Component({
  selector: 'app-prearrangeactivitysummaryreport',
  templateUrl: './prearrangeactivitysummaryreport.component.html',
  styleUrls: ['./prearrangeactivitysummaryreport.component.css']
})
export class PrearrangeactivitysummaryreportComponent implements OnInit {
  formTitle = 'Pre Arranged Activity Head Summary Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  getAllActivities() {
    ...
    this.api.getActivityHeadMaster(0, 0, 'id', 'desc', ' AND STATUS=1').subscribe((data) => {
      if (data['code'] == 200) {
  ...
  sort(params: NzTableQueryParams): void {
    ...
    const sortField = (currentSort && currentSort.key) || 'ACTIVITY_HEAD';
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      obj1['Pre Arranged Activity Head Name'] = this.exportdataList[i]['HEAD_NAME'];
      obj1['No of Users Started'] = this.exportdataList[i]['NUMBER_OF_USER'];
      obj1['No of Users Completed'] = this.exportdataList[i]['NUMBER_OF_USER_COMPLETED'];
      ...
      if (i == this.exportdataList.length - 1) {
        this.exportservice.exportExcel(
          arry1,
          'Pre Arranged Activity Summary Report ' +
