...
@Component({
  selector: 'app-subscriptionsummaryreport',
  templateUrl: './subscriptionsummaryreport.component.html',
  styleUrls: ['./subscriptionsummaryreport.component.css'],
})
export class SubscriptionsummaryreportComponent implements OnInit {
  formTitle = 'Subscription Summary Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  sortKey: string = 'SUBSCRIPTION_ID';
  searchText: string = '';
  filterQuery: string = '';
  ...
  sort(params: NzTableQueryParams): void {
    ...
    const sortField = (currentSort && currentSort.key) || 'SUBSCRIPTION_ID';
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['No Of Active Users'] = this.exportdataList[i]['NUMBER_OF_ACTIVE_USERS'];
