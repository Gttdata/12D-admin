...
@Component({
  selector: 'app-trackbookpurchasehistory',
  templateUrl: './trackbookpurchasehistory.component.html',
  styleUrls: ['./trackbookpurchasehistory.component.css']
})
export class TrackbookpurchasehistoryComponent implements OnInit {
  formTitle = 'Tracbook Task Summary Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Purchase Date'] = this.exportdataList[i]['PURCHASE_DATE']
        ...
        : this.exportdataList[i]['PURCHASE_DATE'];
      obj1['No Of Task Selected'] = this.exportdataList[i]['NO_OF_TASK_SELECTED'];
      // obj1['STATUS'] =
