...
@Component({
  selector: 'app-userbmireport',
  templateUrl: './userbmireport.component.html',
  styleUrls: ['./userbmireport.component.css'],
})
export class UserbmireportComponent implements OnInit {
  formTitle = "User's BMI Report";
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Weight'] = this.exportdataList[i]['WEIGHT']
        ? this.exportdataList[i]['WEIGHT'] +
          ' ' +
          this.exportdataList[i]['WEIGHT_UNIT']
        : '';
      obj1['Height'] = this.exportdataList[i]['HEIGHT']
        ? this.exportdataList[i]['HEIGHT'] +
          ' ' +
          this.exportdataList[i]['HEIGHT_UNIT']
        : '';
      obj1['BMI'] = this.exportdataList[i]['BMI'];
