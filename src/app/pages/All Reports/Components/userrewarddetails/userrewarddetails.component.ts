...
@Component({
  selector: 'app-userrewarddetails',
  templateUrl: './userrewarddetails.component.html',
  styleUrls: ['./userrewarddetails.component.css'],
})
export class UserrewarddetailsComponent implements OnInit {
  formTitle = 'User Wise Reward Details Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Reward'] = this.exportdataList[i]['REWARD_NAME'];
      if (this.exportdataList[i]['STATUS'] == 'L') {
        obj1['Status'] = 'Lock';
      } else if (this.exportdataList[i]['STATUS'] == 'U') {
        obj1['Status'] = 'Unlock';
      } else if (this.exportdataList[i]['STATUS'] == 'O') {
        obj1['Status'] = 'Open';
      }
      ...
      if (i == this.exportdataList.length - 1) {
        this.exportservice.exportExcel(
          arry1,
          'User Wise Reward Detailed Report ' +
