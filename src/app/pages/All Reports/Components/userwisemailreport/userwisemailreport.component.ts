...
@Component({
  selector: 'app-userwisemailreport',
  templateUrl: './userwisemailreport.component.html',
  styleUrls: ['./userwisemailreport.component.css']
})
export class UserwisemailreportComponent implements OnInit {

  formTitle = 'User Wise Email Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Sent Datetime'] = this.exportdataList[i]['SEND_DATETIME']
        ? this.datePipe.transform(
            this.exportdataList[i]['SEND_DATETIME'],
            'dd/MMM/yyyy HH:mm'
          )
        : this.exportdataList[i]['SEND_DATETIME'];
