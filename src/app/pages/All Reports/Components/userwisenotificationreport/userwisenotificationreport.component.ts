...
@Component({
  selector: 'app-userwisenotificationreport',
  templateUrl: './userwisenotificationreport.component.html',
  styleUrls: ['./userwisenotificationreport.component.css']
})
export class UserwisenotificationreportComponent implements OnInit {
  formTitle = 'User Wise Notification Details Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Message Content'] = this.exportdataList[i]['DESCRIPTION'];
