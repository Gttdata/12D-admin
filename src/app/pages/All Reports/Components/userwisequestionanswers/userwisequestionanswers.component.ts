...
@Component({
  selector: 'app-userwisequestionanswers',
  templateUrl: './userwisequestionanswers.component.html',
  styleUrls: ['./userwisequestionanswers.component.css'],
})
export class UserwisequestionanswersComponent implements OnInit {
  formTitle = 'User Wise Question Answer Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Answered Datetime'] = this.exportdataList[i]['CREATED_MODIFIED_DATE']
        ? this.datePipe.transform(
            this.exportdataList[i]['CREATED_MODIFIED_DATE'],
            'dd/MMM/yyyy HH:mm'
          )
        : this.exportdataList[i]['CREATED_MODIFIED_DATE'];
      obj1['Question'] = this.exportdataList[i]['QUESTION_LABEL'];
      obj1['Selected Option'] = this.exportdataList[i]['OPTION_LABEL'];
      ...
      if (i == this.exportdataList.length - 1) {
        this.exportservice.exportExcel(
          arry1,
          'User Wise Question Answer Report ' +
