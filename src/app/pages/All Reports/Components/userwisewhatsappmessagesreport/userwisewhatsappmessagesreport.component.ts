...
@Component({
  selector: 'app-userwisewhatsappmessagesreport',
  templateUrl: './userwisewhatsappmessagesreport.component.html',
  styleUrls: ['./userwisewhatsappmessagesreport.component.css'],
})
export class UserwisewhatsappmessagesreportComponent implements OnInit {
  formTitle = 'User Wise Whatsapp Message Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  columns: string[][] = [
    // ['NAME', 'NAME'],
    ['MESSAGE_CONTAIN', 'MESSAGE_CONTAIN'],
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      ...
      obj1['Message Content'] = this.exportdataList[i]['MESSAGE_CONTAIN'];
      obj1['Sent Datetime'] = this.exportdataList[i]['CREATED_MODIFIED_DATE']
      ...
      obj1['STATUS'] =
        this.exportdataList[i]['STATUS'] 

      arry1.push(Object.assign({}, obj1));
      if (i == this.exportdataList.length - 1) {
        this.exportservice.exportExcel(
          arry1,
          'User Wise Whatsapp Message Report ' +
