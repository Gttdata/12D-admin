...
@Component({
  selector: 'app-whatsappotpreports',
  templateUrl: './whatsappotpreports.component.html',
  styleUrls: ['./whatsappotpreports.component.css'],
})
export class WhatsappotpreportsComponent implements OnInit {
  formTitle = 'Whatsapp Otp Report';
  dataList: any[] = [];
  exportdataList: any[] = [];
  ...
  columns: string[][] = [
    // ['NAME', 'NAME'],
    ['WHATS_APP_CONTACT_NUMBER', 'WHATS_APP_CONTACT_NUMBER'],
    ['OTP', 'OTP'],
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.exportdataList.length; i++) {
      obj1['WhatsApp Contact Number'] = this.exportdataList[i]['WHATS_APP_CONTACT_NUMBER'];
      obj1['OTP'] = this.exportdataList[i]['OTP'];
      obj1['Delivered Datetime'] = this.exportdataList[i]['DELIEVERED_DATE_TIME']
        ? this.datePipe.transform(
            this.exportdataList[i]['DELIEVERED_DATE_TIME'],
            'dd/MMM/yyyy HH:mm'
          )
        : this.exportdataList[i]['DELIEVERED_DATE_TIME'];
      // obj1['Total Amount'] = this.exportdataList[i]['AMOUNT'];
      obj1['STATUS'] = this.exportdataList[i]['STATUS'];
